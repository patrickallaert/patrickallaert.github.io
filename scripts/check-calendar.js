...
assert.equal(on("2026-09-02").find((event) => event.id === "free-intro-guinguette-2-september").start, "2026-09-02T19:30:00");
...
assert.equal(on("2026-09-21").find((event) => event.id === "free-intro-ten-noey-21-september").venue, "GC Ten Noey");
